...
data.frame2013 <- readr::read_csv("accident_2013.csv.bz2")
data.frame2014 <- readr::read_csv("accident_2014.csv.bz2")
data.frame2015 <- readr::read_csv("accident_2015.csv.bz2")
